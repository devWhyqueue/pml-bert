...
def _finetune_model(model: nn.Module, train_dataset: FineTuningDataset, val_dataset: FineTuningDataset,
    ...
    for epoch in range(config["num_epochs"]):
        ...
        _evaluate_on_all_datasets(model, train_dataset, val_dataset, test_dataset, config)
        scheduler.step()
...
def _evaluate_on_all_datasets(model: nn.Module, train_dataset: FineTuningDataset, val_dataset: FineTuningDataset,
